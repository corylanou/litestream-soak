...
func DefaultMainFleet() FleetSpec {
	workers := []DesiredWorker{
		...
		},
		{
			...
			Name:         "worker-main-provider-http-408",
			Source:       "main",
			GitSHA:       "main",
			ProfileName:  "provider-http-408",
			Region:       "ord",
			VolumeSizeGB: 100,
			Workload: workload.Config{
				LoadMode:                      "synthetic",
		...
		},
		{
			...
			Name:         "worker-main-provider-request-canceled",
			Source:       "main",
			GitSHA:       "main",
			ProfileName:  "provider-request-canceled",
			Region:       "ord",
			VolumeSizeGB: 100,
			Workload: workload.Config{
				LoadMode:                      "synthetic",
				...
				S3Concurrency:                 1,
				S3FaultProxyEnabled:           true,
				S3FaultProxyMode:              "provider-request-canceled",
				S3FaultProxyListenAddr:        "127.0.0.1:19000",
				S3FaultProxyMinContentLength:  0,
				S3FaultProxyResetAfterBytes:   1,
				S3FaultProxyFailFirstAttempts: 1,
