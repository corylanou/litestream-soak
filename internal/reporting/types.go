...
const (
	LitestreamMetricsScrapeStatusHealthy = "healthy"
	LitestreamMetricsScrapeStatusFailed  = "failed"
)

const (
	LitestreamMetricsStatusUnknown       = "unknown"
	LitestreamMetricsStatusHealthy       = "healthy"
	LitestreamMetricsStatusScrapeFailed  = "scrape_failed"
	LitestreamMetricsStatusMetricMissing = "metric_missing"
)
...
const (
	...
	WorkerEventLitestreamMetricsScrapeFailed = "litestream_metrics_scrape_failed"
	WorkerEventLitestreamMetricsMissing      = "litestream_metrics_missing"
	WorkerEventLitestreamMetricsRecovered    = "litestream_metrics_recovered"
)
...
type RuntimePayload struct {
	...
	LitestreamMetricsScrapeStatus              string    `json:"litestream_metrics_scrape_status,omitempty"`
	LitestreamMetricsScrapeError               string    `json:"litestream_metrics_scrape_error,omitempty"`
	LitestreamMetricsScrapeAttemptedAt         time.Time `json:"litestream_metrics_scrape_attempted_at,omitempty"`
	LitestreamMetricsScrapeLastSuccessAt       time.Time `json:"litestream_metrics_scrape_last_success_at,omitempty"`
	LitestreamMetricsScrapeConsecutiveFailures int       `json:"litestream_metrics_scrape_consecutive_failures,omitempty"`
	LitestreamDiskFullMetricPresent            bool      `json:"litestream_disk_full_metric_present"`
	LitestreamDiskFull                         bool      `json:"litestream_disk_full"`
	LitestreamMemStatsMetricsPresent           bool      `json:"litestream_memstats_metrics_present"`
...
func LitestreamMetricsStatus(payload *RuntimePayload) string {
	if payload == nil {
		return LitestreamMetricsStatusUnknown
	}
	switch strings.TrimSpace(payload.LitestreamMetricsScrapeStatus) {
	case LitestreamMetricsScrapeStatusFailed:
		return LitestreamMetricsStatusScrapeFailed
	case LitestreamMetricsScrapeStatusHealthy:
		if !payload.LitestreamDiskFullMetricPresent || !payload.LitestreamMemStatsMetricsPresent {
			return LitestreamMetricsStatusMetricMissing
		}
		return LitestreamMetricsStatusHealthy
	default:
		return LitestreamMetricsStatusUnknown
	}
}
