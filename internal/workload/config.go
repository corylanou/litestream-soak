...
type Config struct {
	...
	S3FaultProxyMode                          string  `json:"s3_fault_proxy_mode,omitempty"`
	...
	S3FaultProxyMaxFailures                   int     `json:"s3_fault_proxy_max_failures,omitempty"`
	S3FaultProxySourceLevel                   string  `json:"s3_fault_proxy_source_level,omitempty"`
	S3FaultProxyRequireObservedSourceGet      bool    `json:"s3_fault_proxy_require_observed_source_get,omitempty"`
	S3FaultProxyRequireObservedSourceRangeGet bool    `json:"s3_fault_proxy_require_observed_source_range_get,omitempty"`
